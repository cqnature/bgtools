...
def generate_mail_report_at_date(platform, start_date, end_date):
    # version_datas = None
...
def generate_mail_report(platform, start_date, end_date):
    ...
    reportstring = generate_mail_report_at_date(platform, start_date, end_date)
    print reportstring
